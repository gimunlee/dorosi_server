...
module.exports = function (app, mongoose) {
    ...
    //     Dictionary.findOne({ 'tag': "capitals" }, function (err, doc) {
    //         words = doc.words;
